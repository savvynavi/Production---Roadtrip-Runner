...
public class CollectableSpawner : MonoBehaviour
{
    ...
    public int ChanceOutOf100 = 50;         //Controls how likely it is that a collectable will spawn
    ...
    void Start ()
    {
        ...
        if (Random.Range(1, 100) <= ChanceOutOf100)
        {
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        //Code to add score/money to player for upgrades to go here later
